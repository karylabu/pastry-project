...
export default function ProductCard({
  ...
  const overallOutOfStock = product?.available === false
  ...
  return (
    ...
    >
      <div className="mb-4 flex h-32 w-full flex-shrink-0 items-center justify-center overflow-hidden bg-transparent p-0">
        <img
          src={resolveProductImage(product)}
          alt={product.name}
          onError={(event) => { event.currentTarget.src = `${BASE}/uploads/cake.jpg`; }}
          className="h-[118px] w-auto max-w-[78%] max-h-[118px] object-contain object-center"
        />
      </div>
