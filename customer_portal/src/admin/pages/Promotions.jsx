        ...
        <div className="mx-auto max-w-[1400px] px-6 py-8 md:px-10">
          ...
          <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
            <Panel
              ...
              action={
                <div className="inline-flex items-center gap-2 rounded-full border border-[#d9c7ad] bg-[#f7f3ee] px-3 py-1.5 text-[9px] font-semibold uppercase tracking-[0.2em] text-[#7a5d3d]">
                  <Megaphone size={11} />
                  Admin
                </div>
              }
                ...
                <div className="space-y-4">
                  <label className="block">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-black/10 bg-[#faf7f1] px-3.5 py-3 text-[14px] text-black placeholder:text-black/35 focus:outline-none focus:ring-1 focus:ring-[#d7c8ab]"
                    />
                  </label>

                  <label className="block">
                    <span className="mb-2 block text-[10px] font-semibold uppercase tracking-[0.2em] text-black/45">Coupon code</span>
                    <div className="flex items-center gap-2 rounded-xl border border-black/10 bg-[#faf7f1] px-3.5 py-3">
                      ...
                      <input
                        ...
                        className="w-full bg-transparent text-[14px] text-black placeholder:text-black/35 outline-none"
                      />
                    </div>
                  </label>
                  ...
                  <label className="block">
                    ...
                    <textarea
                      ...
                      className="w-full rounded-xl border border-black/10 bg-[#faf7f1] px-3.5 py-3 text-[14px] leading-6 text-black placeholder:text-black/35 focus:outline-none focus:ring-1 focus:ring-[#d7c8ab]"
                    />
                  </label>
                  ...
                  <label className="block">
                    ...
                    <div className="rounded-xl border border-dashed border-black/15 bg-[#faf7f1] p-3">
                      <label className="flex cursor-pointer items-center gap-3 rounded-lg border border-black/10 bg-white px-3.5 py-3 transition hover:border-black/25">
            ...
            <Panel eyebrow="Recent campaigns" title="Campaign history">
              <div className="p-5">
                {loading ? (
                  <div className="flex min-h-[220px] items-center justify-center rounded-xl border border-dashed border-black/10 bg-[#faf7f1] text-sm text-black/50">
                    <Loader2 size={16} className="mr-2 animate-spin" />
                    Loading promotions...
                  </div>
                ) : promotions.length === 0 ? (
                  <div className="flex min-h-[220px] items-center justify-center rounded-xl border border-dashed border-black/10 bg-[#faf7f1] text-center text-sm text-black/50">
                    No promotions have been sent yet.
                  </div>
                ) : (
                  <div className="space-y-3">
                    {promotions.map((promotion) => (
                      <div key={promotion.id} className="rounded-xl border border-black/10 bg-[#faf7f1] p-4">
                        <div className="flex items-start justify-between gap-3">
                          <div>
                            <p className="text-[16px] font-semibold text-black">{promotion.title}</p>
                            <p className="mt-1 text-[13px] text-black/60">{promotion.description}</p>
                          </div>
                          <span className="rounded-full bg-[#f0e7d8] px-2 py-1 text-[9px] font-semibold uppercase tracking-[0.15em] text-black/60">
